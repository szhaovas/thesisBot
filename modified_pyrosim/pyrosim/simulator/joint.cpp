...
void JOINT::Create_Proprioceptive_Sensor(int myID, int evalPeriod, bool locheck, double lo) {

        proprioceptiveSensor = new PROPRIOCEPTIVE_SENSOR(myID,evalPeriod,locheck,lo);
}
